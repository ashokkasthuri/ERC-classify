...
exports.default = {
    ...
    ERC173: {
        ...
        events: {
            '8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0': 'event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)',
        },
    },
    ERC20: {
        ...
        functions: {
            dd62ed3e: 'function allowance(address _owner, address _spender) view returns (uint256 remaining)',
            ...
            '23b872dd': 'function transferFrom(address _from, address _to, uint256 _value) returns (bool success)',
        },
        events: {
            '8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925': 'event Approval(address indexed _owner, address indexed _spender, uint256 _value)',
            ddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef: 'event Transfer(address indexed _from, address indexed _to, uint256 _value)',
        },
    },
    ERC20Metadata: {
        selectors: [
